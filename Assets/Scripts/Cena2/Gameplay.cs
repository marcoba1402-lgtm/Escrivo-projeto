...
public class Gameplay : MonoBehaviour
{
    ...
    string[,] palavrasFacil = new string[,]
    {
        ...
        {"D","Jogo","DOMINO","pecas com pintinhas","jogo de mesa","tem a peca de sena"},
        ...
        {"I","Brinquedo","IOIO","sobe e desce","tem um barbante","enrola na mao"},
        ...
        {"P","Brinquedo","PIAO","roda no chao","tem uma ponta","enrola o barbante"},
    ...
    string[,] palavrasDificil = new string[,]
    {
        ...
        {"H","Cozinha","HORTELA","erva cheirosa","usada no suco","tambem enfeita prato"},
        ...
        {"J","Cozinha","JILO","verdura amarga","frito ou cozido","nem todo mundo gosta"},
        ...
        {"O","Casa","ORATORIO","armario com santo","tem vela acesa","fica na sala"},
        ...
        {"X","Quimica","XENONIO","gas nobre","seu simbolo e Xe","usado em lampadas de alta intensidade"},
